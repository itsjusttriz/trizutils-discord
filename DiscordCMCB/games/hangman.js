...
export class HangmanGame {
    ...
    newGame(client, msg) {
        ...
        this.guesssed = [];
        this.wrongs = 0;
        this.credit = `${client.systemEmojis.get('BACKEND_INFO')} Thank you to [TurkeyDev](https://discord.gg/DkexpJj) for the Hangman source code! <3`;
