...
const rpgbits = ['RPGAyaya RPGBukka RPGBukkaNoo RPGEmpty RPGEpicStaff RPGEpicSword RPGFei RPGFireball RPGGhosto RPGMana RPGOops RPGPhatLoot RPGShihu RPGStaff RPGTreeNua RPGYonger RPGHP RPGSeven'];
const hahahalidays = ['HahaTurtledove HahaThisisfine HahaThink HahaSweat HahaSleep HahaShrugRight HahaShrugMiddle HahaShrugLeft HahaReindeer HahaPresent HahaSnowhal HahaPoint HahaNutcracker HahaLean HahaHide HahaGoose HahaGingercat HahaElf HahaDoge HahaCat HahaBaby HahaDreidel HahaBall Haha2020 HahaNyandeer'];
const hypetrain1 = ['[Level 1] HypeGriffin1 HypeGriffin2 HypeGriffin3 HypeGriffin4 HypeGriffin5 HypeGriffin6 [Level 2] HypeBigfoot1 HypeBigfoot2 HypeBigfoot3 HypeBigfoot4 HypeBigfoot5 HypeBigfoot6 [Level 3] HypeOni1 HypeOni2 HypeOni3 HypeOni4 HypeOni5 HypeOni6 [Level 4] HypeDragon1 HypeDragon2 HypeDragon3 HypeDragon4 HypeDragon5 HypeDragon6 [Level 5] HypeUnicorn1 HypeUnicorn2 HypeUnicorn3 HypeUnicorn4 HypeUnicorn5 HypeUnicorn6'];
const hypetrain2 = ['[Level 1] HypeChimp , HypeGhost , HypeChest , HypeFrog , HypeCherry  (bonus: HypePeace ) [Level 2] HypeSideeye , HypeBrain , HypeZap , HypeShip , HypeSign (bonus: HypeBug ) [Level 3] HypeYikes , HypeRacer , HypeCar , HypeFirst , HypeTrophy (bonus: HypeBanana ) [Level 4] HypeBlock , HypeDaze , HypeBounce , HypeJewel , HypeBlob (bonus: HypeTeamwork ) [Level 5] HypeLove , HypePunk , HypeKO , HypePunch , HypeFire (bonus: HypePizza )'];
...
module.exports.lgbt2019 = lgbt2019;
module.exports.ffcheck = ffcheck;
module.exports.rpgbits = rpgbits;
module.exports.hahahalidays = hahahalidays;
module.exports.luvcheck = luvcheck;
module.exports.hypetrain1 = hypetrain1;
